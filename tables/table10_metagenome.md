...
| cost vs Pilea, per sample           | 89.5-240.8x at mm=2; 4.0-12.8x (median 8.1x) at mm=1                                                | both measured against Pilea defaults; mm=1 loses a median ~4.7% of detected anchors and no genome on all nine samples |
