...
*Review revision 2026-09-18. The primary Zheng grid uses signed fixed-origin fitting and single-pass GC correction; residual two-pass GC correction is diagnostic only.*
